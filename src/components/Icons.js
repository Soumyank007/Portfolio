...
export const CircularText = ({ className, ...rest }) => (
  <Image priority className={`${className} animate-spin-slow`} {...rest} src='/images/circular-text.png' alt='image' width='496' height='496'></Image>
);

export const CircularTextInverted = ({ className, ...rest }) => (
  <Image priority className={`${className} animate-spin-slow`} {...rest} src='/images/circular-text-inverted.png' alt='image' width='496' height='496'></Image>
);
