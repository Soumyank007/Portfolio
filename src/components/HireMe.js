...
const ComponentWithNoSSR = dynamic(() => Promise.resolve(CircularComponent), {
  ...
  return (
    <div className='fixed z-20 md:absolute flex left-[-1.8rem] bottom-6 items-center justify-center overflow-hidden md:right-6 md:left-auto md:top-4 md:bottom-auto'>
        <div className='w-[11rem] md:w-[5rem] h-auto flex items-center justify-center relative'>
