        ...
        <Layout className="pt-0 md:p-8 sm:pt-4">
          <div className="flex items-center justify-between w-full relative lg:flex-col">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              <AnimatedText text='Crafting Digital Marvels with the Power of Code and Creativity.' className='!text-6xl !text-left xl:!text-5xl lg:!text-center lg:!text-6xl md::!text-5xl sm:!text-3xl' />
