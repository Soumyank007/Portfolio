        ...
        <Layout className="pt-0">
          <div className="flex items-center justify-between w-full relative">
            <div className="w-1/3 relative">
              <Image priority sizes='(min-width: 808px) 50vw, 100vw' src={profilePic} alt="alt" className="w-full h-auto" />
            ...
            <div className="w-1/2 flex flex-col items-center self-center">
              ...
              <p className='my-4 text-base font-medium'>
                With a knack for Full-stack wizardry, I specialize in bringing your ideas to life through innovative web and mobile applications. Dive into my latest projects and insightful articles, highlighting my expertise in app development and design.
              </p>
              <div className='flex items-center self-start mt-2'>
                <Link href="/Soumyank_Padhy_Resume.pdf" className='flex items-center bg-dark text-light p-2.5 px-6 rounded-lg text-lg font-semibold hover:bg-white hover:text-dark border-2 border-solid border-transparent hover:border-dark dark:bg-light dark:text-dark hover:dark:bg-dark hover:dark:text-light hover:dark:border-light' target={'blank'}>Resume<LinkArrow className={'w-6 ml-1'} /></Link>
